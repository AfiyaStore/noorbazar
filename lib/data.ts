  ...
  webPages: [
    {
      title: 'About Us',
      slug: 'about-us',
      content: `Welcome to NoorBazer, your trusted destination for quality products and exceptional service. Our journey began with a mission to bring you the best shopping experience by offering a wide range of products at competitive prices, all in one convenient platform.
...
As we continue to grow, our commitment to quality and service remains unwavering. Thank you for choosing NoorBazer—we look forward to being a part of your journey and delivering value every step of the way.`,
      isPublished: true,
    },
    {
      title: 'Contact Us',
...
- **Email:** support@noorbazar.com
- **Phone:** +8801410780770
- **Live Chat:** Available on our website from 9 AM to 6 PM (Friday to Friday).
...
`,
    ...
    },
    {
      ...
      content: `At NoorBazer, our customer service team is here to ensure you have the best shopping experience. Whether you need assistance with orders, product details, or returns, we are committed to providing prompt and helpful support.
